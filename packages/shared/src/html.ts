 ...
 * The previous version deliberately skipped `'` despite the docstring
 * claim; a contributor using this helper for a single-quoted attribute
 * would have had no indication the output was unsafe.
 */
 ...
 *   - Lowercase ASCII `a-z 0-9` + interior `-` only.
 *   - Length 1..63 (DNS label cap).
 *   - No leading / trailing hyphen.
 *   - No IDN / Unicode / uppercase input. Callers that take user input
 *     must NFC-normalize + lowercase BEFORE validating. This function
 ...
 *     canonical on-chain registration form.
 */
