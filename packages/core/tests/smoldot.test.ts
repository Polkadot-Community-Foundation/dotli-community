...
vi.mock("@dotli/core/chain-specs", () => ({
...
let getSmoldot: typeof import("@dotli/core/smoldot").getSmoldot;
let getRelayChain: typeof import("@dotli/core/smoldot").getRelayChain;
let releaseResolverMutex: typeof import("@dotli/core/smoldot").releaseResolverMutex;
let waitForResolverRelease: typeof import("@dotli/core/smoldot").waitForResolverRelease;
let makeNonRemovingChain: typeof import("@dotli/core/smoldot").makeNonRemovingChain;

beforeEach(async () => {
  vi.resetModules();
  const mod = await import("@dotli/core/smoldot");
